...
function AssumptionsCard() {
    return `
    <div class="${css.card} w-full mt-6 overflow-hidden">
        <div class="p-4 md:p-5 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex items-center gap-2">
            <i data-lucide="scale" class="w-5 h-5 text-indigo-500 dark:text-indigo-400"></i>
            <h3 class="font-bold text-zinc-900 dark:text-white uppercase tracking-wide text-sm md:text-base">System Assumptions & Roster Parameters</h3>
        </div>
        <div class="p-0 grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-zinc-200 dark:divide-zinc-800">
            
            <div class="p-5 md:p-6 space-y-6">
                <h4 class="text-[11px] font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-400 border-b border-zinc-200 dark:border-zinc-800 pb-2">Mathematical Framework</h4>
                
                <div class="flex gap-4">
                    <div class="w-10 h-10 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center shrink-0 border border-indigo-100 dark:border-indigo-500/20"><i data-lucide="battery-charging" class="w-5 h-5 text-indigo-600 dark:text-indigo-400"></i></div>
                    <div>
                        <div class="text-sm font-bold text-zinc-900 dark:text-white mb-1">15 Hrs/Week Duty Capacity</div>
                        <div class="text-[13px] text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">Effective net capacity per individual after deducting standard office duties, annual leave, training, and 44-hour statutory limits.</div>
                    </div>
                </div>

                <div class="flex gap-4">
                    <div class="w-10 h-10 rounded-xl bg-amber-50 dark:bg-amber-500/10 flex items-center justify-center shrink-0 border border-amber-100 dark:border-amber-500/20"><i data-lucide="shield-alert" class="w-5 h-5 text-amber-600 dark:text-amber-400"></i></div>
                    <div>
                        <div class="text-sm font-bold text-zinc-900 dark:text-white mb-1">3.68 Effective Reserve Shifts</div>
                        <div class="text-[13px] text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">Personnel can effectively clear ~192 shifts per year (3.68 per week). 1 Reserve is automatically enforced per active on-site shift.</div>
                    </div>
                </div>

                <div class="flex gap-4">
                    <div class="w-10 h-10 rounded-xl bg-orange-50 dark:bg-orange-500/10 flex items-center justify-center shrink-0 border border-orange-100 dark:border-orange-500/20"><i data-lucide="phone-call" class="w-5 h-5 text-orange-600 dark:text-orange-400"></i></div>
                    <div>
                        <div class="text-sm font-bold text-zinc-900 dark:text-white mb-1">Standby Buffer Ratio</div>
                        <div class="text-[13px] text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">Standby calculations assume 2 physical activations (24 hours each) per month, resulting in a ~12 hour/week continuous load per assigned individual.</div>
                    </div>
                </div>
            </div>

            <div class="p-5 md:p-6 space-y-6">
                <h4 class="text-[11px] font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-400 border-b border-zinc-200 dark:border-zinc-800 pb-2">Roster Engine Heuristics</h4>

                <div class="flex gap-4">
                    <div class="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center shrink-0 border border-emerald-100 dark:border-emerald-500/20"><i data-lucide="clock-4" class="w-5 h-5 text-emerald-600 dark:text-emerald-400"></i></div>
                    <div>
                        <div class="text-sm font-bold text-zinc-900 dark:text-white mb-1">11-Hour Minimum Rest</div>
                        <div class="text-[13px] text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">Strict enforcement of a minimum 11-hour rest block between active shift duties and standard office hours to prevent physical burnout.</div>
                    </div>
                </div>

                <div class="flex gap-4">
                    <div class="w-10 h-10 rounded-xl bg-red-50 dark:bg-red-500/10 flex items-center justify-center shrink-0 border border-red-100 dark:border-red-500/20"><i data-lucide="calendar-off" class="w-5 h-5 text-red-600 dark:text-red-400"></i></div>
                    <div>
                        <div class="text-sm font-bold text-zinc-900 dark:text-white mb-1">Dynamic Off-In-Lieu (OIL)</div>
                        <div class="text-[13px] text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">Active duties falling on standard office hours (Mon-Fri 0800-1730) will automatically waive the office block to offset the maximum 44-hour statutory limit.</div>
                    </div>
                </div>

                <div class="flex gap-4">
                    <div class="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center shrink-0 border border-blue-100 dark:border-blue-500/20"><i data-lucide="split-square-horizontal" class="w-5 h-5 text-blue-600 dark:text-blue-400"></i></div>
                    <div>
                        <div class="text-sm font-bold text-zinc-900 dark:text-white mb-1">Concurrency Constraints</div>
                        <div class="text-[13px] text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">Reserve pools do not share headcount with Standby pools. Overlapping concurrent roles are waived from 11-hour bounds exclusively if explicitly mapped.</div>
                    </div>
                </div>
            </div>
